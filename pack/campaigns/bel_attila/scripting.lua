...
require("att_start");
require("att_traits");
require("lib_spawn_army");
--require("byzantine_neutrality");
require("empire_defense/empire_retaliates");
require("calculate_human_factions");
require("restrict_resource");
...
require("army_upkeep");
require("barbarian_invasions");
require("diplomacy_limiting");
require("krakatoa_events");
require("ostrogothi_trait");
require("plague_of_justinian");
require("puppet_prevention");
require("scripted_incidents");
require("western_roman_empire");
require("win_video");
require("empire_defense/core_region_defense");
require("empire_defense/empire_activates");
require("empire_defense/expedition_independence");
require("empire_defense/siege_defense_bonus");
require("empire_defense/spawn_defense_forces");
