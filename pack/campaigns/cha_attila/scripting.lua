...
require("att_start");
require("att_traits");
require("button_disabling");
require("war_weariness");
require("irminsul");
require("events/pope");
require("events/kingdom_lists");
require("events/kingdom_events");

require("events/story/asturias_story");
require("events/story/avars_story");
require("events/story/charlemagne_story");
require("events/story/carlomans_death");
require("events/story/cordoba_story");
require("events/story/danes_story");
require("events/story/lombards_story");
require("events/story/mercia_story");
require("events/story/westphalia_story");
